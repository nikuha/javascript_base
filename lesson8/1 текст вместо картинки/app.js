...
function showMoreText(card) {
    ...
    let product_details = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit';
    
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class="desc">${product_details}</div>`)
